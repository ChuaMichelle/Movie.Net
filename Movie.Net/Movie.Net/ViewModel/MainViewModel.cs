...
namespace Movie.Net.ViewModel
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public RelayCommand LogOutAndExitCommand { get; set; }
        ...
        public MainViewModel()
        {
            ...
            LogOutAndExitCommand = new RelayCommand(LogOutAndExitExecute, MyCommandsCanExecute);
        }
                ...
                if (ctx.Users.Any(u => u.Login == AuthViewModel.CurrentUser.Login))
                {
                    if (ctx.Users.Any(u => u.Login == AuthViewModel.CurrentUser.Login && u.Password == AuthViewModel.CurrentUser.Password))
                    {
                        if (AuthViewModel.IsNotAuthenticated)
                        {
                            ...
                            var movieListWindow = new View.MovieCommentAndNote();
                            //var movieListWindow = new View.TestMovieListWindow();
        ...
        private void LogOutAndExitExecute()
        {
            LogoutExecute();
